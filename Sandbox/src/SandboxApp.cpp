...
public:
		...
		:Layer("Example"), m_Camera(-1.6f, 1.6f, -0.9f, 0.9f), m_CameraPosition(0.0f)
	{
		...
		Cicala::Ref<Cicala::VertexBuffer> vertexBuffer;
		...
		Cicala::Ref<Cicala::IndexBuffer> indexBuffer;
		...
		Cicala::Ref<Cicala::VertexBuffer> squareVB;
		squareVB.reset(Cicala::VertexBuffer::Create(squareVertices, sizeof(squareVertices)));
		squareVB->SetLayout({
			{ Cicala::ShaderDataType::Float3, "a_Position" },
			{ Cicala::ShaderDataType::Float2, "a_TexCoord" }
			});
		m_SquareVA->AddVertexBuffer(squareVB);

		uint32_t squareIndices[6] = { 0, 1, 2, 2, 3, 0 };
		Cicala::Ref<Cicala::IndexBuffer> squareIB;
