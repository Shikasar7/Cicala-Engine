...
namespace Cicala {
	...
	Cicala::Ref<Cicala::Shader> ShaderLibrary::Load(const std::string& filepath)
	{
	...
	Cicala::Ref<Cicala::Shader> ShaderLibrary::Load(const std::string& name, const std::string& filepath)
	{
		auto shader = Shader::Create(filepath);
		Add(name, shader);
		return shader;
	...
	Cicala::Ref<Cicala::Shader> ShaderLibrary::Get(const std::string& name)
	{
